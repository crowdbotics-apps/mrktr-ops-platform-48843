"""
Django settings for mrktr_ops_platform_48843 project.
...
ROOT_URLCONF = 'mrktr_ops_platform_48843.urls'
...
WSGI_APPLICATION = 'mrktr_ops_platform_48843.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Mrktr Ops Platform Support <support@mrktr-ops-platform-48843.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mrktr_ops_platform_48843 API",
    "DESCRIPTION": "API documentation for mrktr_ops_platform_48843 App",
    "VERSION": "v1",
}
